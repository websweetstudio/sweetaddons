 ...
 */
class Sweet_Addons_Maintenance_Mode
{
    ...
    public function check_recaptcha(){
        ...
        $check_recaptcha = get_option('captcha_sweet_addons');
...
// Inisialisasi class Sweet_Addons_Maintenance_Mode
$sweet_maintenance_mode = new Sweet_Addons_Maintenance_Mode();
