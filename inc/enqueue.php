...
{
  wp_enqueue_style('sweetaddons-style', SWEETADDON_URL . 'assets/css/sweetaddons.min.css', array(), '1.0.0', 'all');
  ...
  wp_enqueue_script('sweetaddons-script', SWEETADDON_URL . 'assets/js/sweetaddons.min.js', array(), '1.0.0', true);
